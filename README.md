...
Add `ahmed-laggoun/laravel-tap-payments` to your `composer.json`.
```
"ahmed-laggoun/laravel-tap-payments": "dev-master"
```
...
OR simply run
```
composer require "ahmed-laggoun/laravel-tap-payments"
```
